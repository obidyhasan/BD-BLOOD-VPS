...
const buttonVariants = cva(
  'cursor-pointer group whitespace-nowrap focus-visible:outline-hidden inline-flex items-center justify-center has-data-[arrow=true]:justify-between whitespace-nowrap text-sm font-medium ring-offset-background transition-all active:scale-95 disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        primary: 'bg-primary text-primary-foreground hover:bg-primary/90 shadow-sm hover:shadow-premium data-[state=open]:bg-primary/90',
        mono: 'bg-zinc-950 text-white dark:bg-zinc-300 dark:text-black hover:bg-zinc-950/90 dark:hover:bg-zinc-300/90 data-[state=open]:bg-zinc-950/90 dark:data-[state=open]:bg-zinc-300/90',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90 data-[state=open]:bg-destructive/90',
        secondary: 'bg-secondary text-secondary-foreground hover:bg-secondary/80 data-[state=open]:bg-secondary/80',
        outline: 'bg-background text-accent-foreground border border-input hover:bg-accent hover:border-accent hover:text-accent-foreground data-[state=open]:bg-accent',
        dashed:
      ...
      size: {
        lg: 'h-11 px-6 text-base gap-2 [&_svg:not([class*=size-])]:size-5',
        md: 'h-10 px-4 gap-1.5 text-sm [&_svg:not([class*=size-])]:size-4',
        sm: 'h-9 px-3 gap-1.25 text-xs [&_svg:not([class*=size-])]:size-3.5',
        xs: 'h-8 px-2.5 gap-1 text-xs [&_svg:not([class*=size-])]:size-3.5',
        icon: 'size-10 [&_svg:not([class*=size-])]:size-5 shrink-0',
      },
      autoHeight: {
        true: '',
        false: '',
      ...
      mode: {
        default: 'focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:ring-offset-2',
        icon: 'focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:ring-offset-2 shrink-0',
        link: 'text-primary h-auto p-0 bg-transparent rounded-none hover:bg-transparent data-[state=open]:bg-transparent hover:underline',
        input: `
            justify-start font-normal border border-input hover:bg-background [&_svg]:transition-colors [&_svg]:hover:text-foreground data-[state=open]:bg-background 
            focus-visible:border-primary focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:ring-primary/10 
            [[data-state=open]>&]:border-primary [[data-state=open]>&]:outline-hidden [[data-state=open]>&]:ring-[3px] 
