...
const inputVariants = cva(
  `
    flex w-full bg-background border border-border/50 shadow-xs shadow-black/5 transition-[color,box-shadow,border-color] text-foreground placeholder:text-muted-foreground/60 
    focus-visible:ring-primary/10 focus-visible:border-primary focus-visible:outline-none focus-visible:ring-[4px]     
    disabled:cursor-not-allowed disabled:opacity-60 
    [&[readonly]]:bg-muted/80 [&[readonly]]:cursor-not-allowed
    file:h-full [&[type=file]]:py-0 file:border-solid file:border-input file:bg-transparent 
    file:font-medium file:not- file:text-foreground file:p-0 file:border-0 file:border-e
    aria-invalid:border-destructive/60 aria-invalid:ring-destructive/10 dark:aria-invalid:border-destructive dark:aria-invalid:ring-destructive/20
  `,
  {
    variants: {
      variant: {
        lg: 'h-11 px-4 text-sm rounded-xl file:pe-4 file:me-4',
        md: 'h-10 px-3.5 text-sm rounded-xl file:pe-3 file:me-3',
        sm: 'h-9 px-3 text-xs rounded-lg file:pe-2.5 file:me-2.5',
      },
    },
    defaultVariants: {
      variant: 'md',
