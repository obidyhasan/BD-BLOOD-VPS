...
const navigationMenuTriggerStyle = cva(
  "cursor-pointer group inline-flex h-10 w-max items-center justify-center rounded-xl bg-transparent px-4 py-2 text-sm font-medium hover:bg-accent/50 hover:text-primary focus:bg-accent/50 focus:text-primary disabled:pointer-events-none disabled:opacity-50 data-[active=true]:bg-accent/50 data-[state=open]:bg-accent/50 data-[active=true]:text-primary ring-primary/10 transition-all duration-200",
);
