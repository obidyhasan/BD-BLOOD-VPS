...
const navItems = [
  ...
  },
  {
    title: "Donors",
    icon: Users,
    items: [{ title: "All Donors", url: "/dashboard/admin/donors" }],
  },
  {
    title: "Organizations",
    icon: Building2,
    items: [
      { title: "All Organizations", url: "/dashboard/admin/organizations" },
      { title: "Members", url: "/dashboard/admin/organization-members" },
    ],
  },
  {
    title: "Blood",
    icon: Droplets,
    items: [
      { title: "Active Requests", url: "/dashboard/admin/blood-requests" },
  ...
  },
  {
    title: "Events",
    icon: CalendarDays,
    items: [{ title: "All Events", url: "/dashboard/admin/events" }],
  },
  {
    title: "Medical",
    icon: Stethoscope,
